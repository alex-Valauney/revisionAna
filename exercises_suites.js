...
window.EXERCISES_BY_CAT["suites"] = [
  {
    ...
    difficulty: "moyen",
    type: "qcm",
    source: "Bac Métropole • Juin 2023 • Sujet 2 – Ex. 3",
    question: "<b>Bac Métropole – Juin 2023 – Sujet 2</b><br>Soit la suite $(u_n)$ définie par $u_0 = 5$ et $u_{n+1} = \\frac{3u_n + 1}{u_n + 3}$. On admet que la suite converge vers une limite réelle $L$ et que $u_n > 1$ pour tout $n \\in \\mathbb{N}$. Déterminer sa limite.",
    options: ["$0$", "$1$", "$3$", "$+\\infty$"],
    correctAnswer: 1,
  ...
  },
  {
    ...
    question: "<b>Bac Antilles-Guyane – Juin 2022 – Sujet 1</b><br>Soit la suite $(u_n)$ définie par $u_0 = 2$ et pour tout $n \\ge 0$, $u_{n+1} = 0{,}5 u_n + 3$. <br> Calculer la limite de cette suite $(u_n)$ en $+\\infty$.",
    correctAnswer: "6",
  ...
  },
  {
    ...
    difficulty: "facile",
    type: "ouvert",
    source: "Bac Métropole • Juin 2021 • Sujet 1 – Ex. 1",
    question: "<b>Bac Métropole – Juin 2021 – Sujet 1</b><br>Soit $(u_n)$ définie par $u_{n+1} = 2u_n - 3$ avec $u_0 = 4$. <br> Calculer la valeur exacte de $u_3$.",
    correctAnswer: "11",
  ...
  },
  {
    ...
    difficulty: "moyen",
    type: "ouvert",
    source: "Bac Métropole • Septembre 2021 • Sujet 1 – Ex. 2",
    question: "<b>Bac Métropole – Septembre 2021 – Sujet 1</b><br>Soit $(u_n)$ une suite géométrique de termes strictement positifs telle que $u_3 = 24$ et $u_5 = 96$. <br> Déterminer la valeur exacte de la raison $q$ de cette suite.",
    correctAnswer: "2",
  ...
  },
  {
    ...
    difficulty: "facile",
    type: "ouvert",
    source: "Bac Amérique du Nord • Juin 2022 • Sujet 1 – Ex. 1",
    question: "<b>Bac Amérique du Nord – Juin 2022 – Sujet 1</b><br>Soit $(u_n)$ définie par $u_0 = 1$ et $u_{n+1} = 0{,}8 u_n + 2$. <br> Quelle est la valeur de la limite théorique de cette suite ?",
    correctAnswer: "10",
  ...
  },
  {
    ...
    question: "<b>Bac Polynésie – Juin 2021 – Sujet 2</b><br>Soit $(u_n)$ la suite arithmétique de premier terme $u_1 = 2$ et de raison $r = 4$. <br> Calculer la somme des 5 premiers termes : $S = u_1 + u_2 + u_3 + u_4 + u_5$.",
    correctAnswer: "50",
  ...
  },
  {
    id: 7,
    category: "suites",
    title: "Limite de suite géométrique de raison < 1",
    difficulty: "facile",
    type: "qcm",
    source: "Bac Asie • Juin 2021 • Sujet 1 – Ex. 2",
    question: "<b>Bac Asie – Juin 2021 – Sujet 1</b><br>Soit la suite $(u_n)$ définie par $u_n = 3 \\times 0{,}75^n - 2$. Quelle est la limite de cette suite ?",
    options: ["$-2$", "$0$", "$3$", "$-\\infty$"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    difficulty: "facile",
    type: "qcm",
    source: "Bac Métropole • Juin 2022 • Sujet 1 – Ex. 3",
    question: "<b>Bac Métropole – Juin 2022 – Sujet 1</b><br>Soit la suite $(u_n)$ définie pour tout entier $n$ par $u_n = n^2 - 4n$. A partir de quel rang $n_0$ la suite est-elle strictement croissante ?",
  ...
  },
  {
    id: 9,
    category: "suites",
    title: "Seuil algorithmique en Python",
    difficulty: "moyen",
    type: "qcm",
    source: "Bac Antilles-Guyane • Juin 2021 • Sujet 1 – Ex. 4",
    question: "<b>Bac Antilles-Guyane – Juin 2021 – Sujet 1</b><br>Soit le script Python suivant :<br><pre>def seuil():\n  u = 2\n  n = 0\n  while u < 100:\n    u = 3*u + 1\n    n = n + 1\n  return n</pre>Quelle valeur renvoie cet algorithme ?",
    options: ["$3$", "$4$", "$5$", "$100$"],
    correctAnswer: 1,
  ...
  },
  {
    id: 10,
    category: "suites",
    title: "Démonstration par récurrence d'une inégalité",
    difficulty: "moyen",
    type: "qcm",
    source: "Bac Mayotte • Juin 2021 • Sujet 1 – Ex. 2",
    question: "<b>Bac Mayotte – Juin 2021 – Sujet 1</b><br>On veut montrer par récurrence que pour tout $n \\ge 1$, $2^n \\ge n + 1$. Lors de l'étape d'hérédité, quelle hypothèse de récurrence doit-on poser ?",
    options: [
  ...
  },
  {
    id: 11,
    category: "suites",
    title: "Limite de suite rationnelle",
    difficulty: "moyen",
    type: "qcm",
    source: "Bac Nouvelle-Calédonie • Juin 2022 • Sujet 1 – Ex. 1",
    question: "<b>Bac Nouvelle-Calédonie – Juin 2022 – Sujet 1</b><br>Quelle est la limite en $+\\infty$ de la suite définie par $u_n = \\frac{2n^2 + 3}{5n^2 - n + 1}$ ?",
  ...
  },
  {
    ...
    type: "ouvert",
    source: "Bac La Réunion • Juin 2021 • Sujet 1 – Ex. 2",
    question: "<b>Bac La Réunion – Juin 2021 – Sujet 1</b><br>Soit $(u_n)$ définie par $u_0 = 1$, $u_1 = 1$ et $u_{n+2} = u_{n+1} + 2u_n$. <br> Calculer la valeur exacte de $u_4$.",
    correctAnswer: "11",
  ...
  },
  {
    ...
    difficulty: "facile",
    type: "qcm",
    source: "Bac Asie • Juin 2022 • Sujet 1 – Ex. 1",
    question: "<b>Bac Asie – Juin 2022 – Sujet 1</b><br>Soit $(u_n)$ une suite croissante et majorée par 5. Que peut-on affirmer ?",
    options: [
  ...
  },
  {
    ...
    question: "<b>Bac Polynésie – Juin 2022 – Sujet 1</b><br>Pour tout réel $a > 0$ et tout entier $n \\in \\mathbb{N}$, l'inégalité de Bernoulli s'écrit :",
    options: [
      "$(1+a)^n \\ge 1 + na$",
      "$(1+a)^n \\le 1 + na$",
      "$(1-a)^n \\ge 1 - na$",
  ...
  },
  {
    id: 15,
    category: "suites",
    title: "Limite de $n! / n^n$",
    difficulty: "difficile",
    type: "qcm",
    source: "Bac Amérique du Nord • Juin 2023 • Sujet 1 – Ex. 3",
    question: "<b>Bac Amérique du Nord – Juin 2023 – Sujet 1</b><br>Soit la suite $(u_n)$ définie pour tout $n \\ge 1$ par $u_n = \\frac{n!}{n^n}$. Quelle est la limite de cette suite ?",
  ...
  },
  {
    ...
    difficulty: "facile",
    type: "ouvert",
    source: "Bac Métropole • Juin 2021 • Sujet 2 – Ex. 1",
    question: "<b>Bac Métropole – Juin 2021 – Sujet 2</b><br>Soit $(u_n)$ une suite arithmétique de premier terme $u_0 = 5$ et de raison $r = 3$. <br> Déterminer le rang $n$ pour lequel $u_n = 35$.",
    correctAnswer: "10",
  ...
  },
  {
    id: 17,
    category: "suites",
    title: "Conjecture de limite sur graphique",
    difficulty: "facile",
    type: "qcm",
    source: "Bac Centres Étrangers • Juin 2023 • Sujet 1 – Ex. 2",
    question: "<b>Bac Centres Étrangers – Juin 2023 – Sujet 1</b><br>Soit la suite $(u_n)$ définie par $u_0=0{,}5$ et représentée par la droite d'équation $y=x$ et la courbe $y = \\sqrt{x}$. Vers quel nombre la suite semble-t-elle converger graphiquement ?",
  ...
  },
  {
    ...
    difficulty: "moyen",
    type: "qcm",
    source: "Bac Métropole • Septembre 2022 • Sujet 2 – Ex. 1",
    question: "<b>Bac Métropole – Septembre 2022 – Sujet 2</b><br>Soit la suite $(u_n)$ telle que pour tout entier $n$, $u_n \\ge n^2 + \\sin(n)$. Déterminer sa limite en $+\\infty$.",
  ...
  },
  {
    id: 19,
    category: "suites",
    title: "Suite décroissante minorée",
    difficulty: "facile",
    type: "qcm",
    source: "Bac Antilles-Guyane • Septembre 2022 • Sujet 1 – Ex. 1",
    question: "<b>Bac Antilles-Guyane – Septembre 2022 – Sujet 1</b><br>Toute suite décroissante et minorée par 0 :",
    options: [
  ...
  },
  {
    ...
    difficulty: "facile",
    type: "ouvert",
    source: "Bac Métropole • Juin 2022 • Sujet 2 – Ex. 1",
    question: "<b>Bac Métropole – Juin 2022 – Sujet 2</b><br>Soit $(u_n)$ une suite géométrique de premier terme $u_0 = 3$ et de raison $q = 2$. <br> Déterminer la valeur exacte de $u_5$.",
    correctAnswer: "96",
