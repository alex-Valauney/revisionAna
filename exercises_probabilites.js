...
window.EXERCISES_BY_CAT["probabilites"] = [
  {
    ...
    question: "<b>Bac Métropole – Juin 2022 – Sujet 2</b><br>Un système exige un code de 4 chiffres distincts choisis parmi $0$ à $9$. Combien de codes différents peut-on former ?",
  ...
  },
  {
    ...
    difficulty: "facile",
    type: "ouvert",
    source: "Bac Amérique du Sud • Juin 2022 • Sujet 1 – Ex. 1",
    question: "<b>Bac Amérique du Sud – Juin 2022 – Sujet 1</b><br>Soit $X$ une variable aléatoire suivant une loi binomiale de paramètres $n = 5$ et $p = 0{,}4$. <br> Calculer l'espérance mathématique $E(X)$.",
    correctAnswer: "2",
  ...
  },
  {
    ...
    question: "<b>Bac Métropole – Juin 2023 – Sujet 1</b><br>Une maladie touche $2\\%$ de la population. Un test de dépistage donne un résultat positif pour $95\\%$ des personnes malades et pour $3\\%$ des personnes saines. Quelle est la probabilité qu'un individu testé au hasard ait un test positif ?",
  ...
  },
  {
    ...
    difficulty: "facile",
    type: "ouvert",
    source: "Bac Antilles-Guyane • Juin 2022 • Sujet 1 – Ex. 2",
    question: "<b>Bac Antilles-Guyane – Juin 2022 – Sujet 1</b><br>Calculer la valeur exacte du coefficient binomial $\\binom{5}{2}$.",
    correctAnswer: "10",
  ...
  },
  {
    id: 65,
    category: "probabilites",
    title: "Dénombrement de sous-comités",
    difficulty: "moyen",
    type: "ouvert",
    source: "Bac Amérique du Nord • Juin 2022 • Sujet 1 – Ex. 4",
    question: "<b>Bac Amérique du Nord – Juin 2022 – Sujet 1</b><br>Combien de comités différents de 3 personnes peut-on former à partir d'un groupe de 6 collaborateurs ?",
    correctAnswer: "20",
  ...
  },
  {
    ...
    difficulty: "moyen",
    type: "ouvert",
    source: "Bac Polynésie • Juin 2022 • Sujet 2 – Ex. 1",
    question: "<b>Bac Polynésie – Juin 2022 – Sujet 2</b><br>Soient deux événements $A$ et $B$ tels que $P(A) = 0{,}5$, $P(B) = 0{,}4$ et $P(A \\cap B) = 0{,}2$. <br> Calculer la probabilité conditionnelle $P_A(B)$ sous sa forme décimale.",
    correctAnswer: "0.4",
  ...
  },
  {
    ...
    question: "<b>Bac Nouvelle-Calédonie – Juin 2022 – Sujet 1</b><br>Deux événements $A$ et $B$ de probabilités non nulles sont indépendants si et seulement si :",
    options: [
  ...
  },
  {
    id: 68,
    category: "probabilites",
    title: "Loi de probabilité d'une variable aléatoire",
    difficulty: "facile",
    type: "qcm",
    source: "Bac La Réunion • Juin 2021 • Sujet 1 – Ex. 3",
    question: "<b>Bac La Réunion – Juin 2021 – Sujet 1</b><br>La somme des probabilités d'une loi de probabilité d'une variable aléatoire discrète $X$ prenant un nombre fini de valeurs est toujours égale à :",
  ...
  },
  {
    ...
    type: "ouvert",
    source: "Bac Asie • Juin 2022 • Sujet 2 – Ex. 2",
    question: "<b>Bac Asie – Juin 2022 – Sujet 2</b><br>Soit une variable aléatoire $X$ prenant les valeurs $0$ et $10$ avec les probabilités $0{,}6$ et $0{,}4$ respectivement. <br> Calculer la variance $V(X)$ de cette variable aléatoire.",
    correctAnswer: "24",
  ...
  },
  {
    id: 70,
    category: "probabilites",
    title: "Permutations et anagrammes",
    difficulty: "moyen",
    type: "qcm",
    source: "Bac Métropole • Juin 2021 • Sujet 1 – Ex. 4",
    question: "<b>Bac Métropole – Juin 2021 – Sujet 1</b><br>Combien d'anagrammes (mots avec ou sans signification) peut-on former en permutant les lettres du mot 'MATH' ?",
    options: ["$4$", "$12$", "$24$", "$256$"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    question: "<b>Bac Antilles-Guyane – Juin 2021 – Sujet 2</b><br>Soit une variable de Bernoulli $X$ de paramètre $p = 0{,}75$. <br> Quelle est la valeur exacte de l'espérance $E(X)$ ?",
    correctAnswer: "0.75",
  ...
  },
  {
    ...
    difficulty: "facile",
    type: "qcm",
    source: "Bac Polynésie • Juin 2022 • Sujet 1 – Ex. 2",
    question: "<b>Bac Polynésie – Juin 2022 – Sujet 1</b><br>Deux événements $A$ et $B$ sont incompatibles si et seulement si :",
    options: [
      "$P(A \\cap B) = 0$",
      "$P(A) \\times P(B) = 1$",
      "$P(A \\cup B) = 1$",
  ...
  },
  {
    ...
    difficulty: "moyen",
    type: "ouvert",
    source: "Bac Amérique du Nord • Juin 2023 • Sujet 2 – Ex. 1",
    question: "<b>Bac Amérique du Nord – Juin 2023 – Sujet 2</b><br>Soit $X$ une variable aléatoire suivant une loi binomiale $\\mathcal{B}(3; 0{,}5)$. <br> Calculer la probabilité exacte $P(X = 0)$ sous sa forme décimale.",
    correctAnswer: "0.125",
  ...
  },
  {
    ...
    difficulty: "moyen",
    type: "qcm",
    source: "Bac Centres Étrangers • Juin 2022 • Sujet 1 – Ex. 3",
    question: "<b>Bac Centres Étrangers – Juin 2022 – Sujet 1</b><br>D'après la relation de Pascal, le coefficient $\\binom{n}{k} + \\binom{n}{k+1}$ est égal à :",
    options: [
      "$\\binom{n+1}{k+1}$",
      "$\\binom{n+1}{k}$",
      "$\\binom{n}{k+2}$",
  ...
  },
  {
    id: 75,
    category: "probabilites",
    title: "Choix ordonné avec répétition",
    difficulty: "facile",
    type: "qcm",
    source: "Bac La Réunion • Juin 2022 • Sujet 2 – Ex. 1",
    question: "<b>Bac La Réunion – Juin 2022 – Sujet 2</b><br>On lance un dé à 6 faces 3 fois de suite en notant le numéro obtenu. Combien de résultats ordonnés peut-on obtenir ?",
  ...
  },
  {
    ...
    difficulty: "facile",
    type: "ouvert",
    source: "Bac Polynésie • Juin 2023 • Sujet 1 – Ex. 1",
    question: "<b>Bac Polynésie – Juin 2023 – Sujet 1</b><br>Soit un événement $A$ tel que $P(A) = 0{,}37$. <br> Calculer la probabilité de l'événement contraire $P(\\bar{A})$ sous sa forme décimale.",
    correctAnswer: "0.63",
  ...
  },
  {
    id: 77,
    category: "probabilites",
    title: "Indépendance de 3 lancers de pièce",
    difficulty: "facile",
    type: "qcm",
    source: "Bac Asie • Juin 2021 • Sujet 2 – Ex. 1",
    question: "<b>Bac Asie – Juin 2021 – Sujet 2</b><br>On lance une pièce de monnaie équilibrée 3 fois. Quelle est la probabilité d'obtenir 3 fois pile ?",
  ...
  },
  {
    ...
    difficulty: "moyen",
    type: "ouvert",
    source: "Bac Antilles-Guyane • Juin 2022 • Sujet 2 – Ex. 2",
    question: "<b>Bac Antilles-Guyane – Juin 2022 – Sujet 2</b><br>Un joueur participe à un jeu où il a $20\\%$ de chances de gagner $10$ € et $80\\%$ de chances de perdre $2$ €. <br> Calculer l'espérance mathématique de gain de ce jeu en euros (donner le nombre).",
    correctAnswer: "0.4",
  ...
  },
  {
    id: 79,
    category: "probabilites",
    title: "Coefficients binomiaux symétriques",
    difficulty: "facile",
    type: "qcm",
    source: "Bac Amérique du Nord • Juin 2021 • Sujet 1 – Ex. 3",
    question: "<b>Bac Amérique du Nord – Juin 2021 – Sujet 1</b><br>Pour tout entier $n$ et tout entier $k \\le n$, le coefficient $\\binom{n}{n-k}$ est égal à :",
    options: [
      "$\\binom{n}{k}$",
      "$\\binom{k}{n}$",
      "$n-k$",
  ...
  },
  {
    ...
    question: "<b>Bac Nouvelle-Calédonie – Juin 2022 – Sujet 2</b><br>Calculer la valeur exacte de $5!$.",
    correctAnswer: "120",
