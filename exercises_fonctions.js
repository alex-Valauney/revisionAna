...
window.EXERCISES_BY_CAT["fonctions"] = [
  {
    ...
    difficulty: "moyen",
    type: "qcm",
    source: "Bac Métropole • Juin 2021 • Sujet 1 – Ex. 2",
    question: "<b>Bac Métropole – Juin 2021 – Sujet 1</b><br>Soit la fonction $f$ définie sur $\\mathbb{R}$ par $f(x) = (x - 1)e^x + 1$. Quelle est la formule de sa dérivée seconde $f''(x)$ ?",
  ...
  },
  {
    ...
    question: "<b>Bac Amérique du Nord – Juin 2023 – Sujet 1</b><br>Soit $f(x) = x e^{x^2}$. Calculer la valeur approchée arrondie à 3 décimales de l'intégrale $I = \\int_0^1 x e^{x^2} dx$.",
    correctAnswer: "0.859",
  ...
  },
  {
    id: 23,
    category: "fonctions",
    title: "Recherche de point d'inflexion",
    difficulty: "moyen",
    type: "qcm",
    source: "Bac Métropole • Juin 2023 • Sujet 1 – Ex. 3",
    question: "<b>Bac Métropole – Juin 2023 – Sujet 1</b><br>Soit la fonction $f$ dont la dérivée seconde est $f''(x) = (x^2 - 4)e^x$. Combien de points d'inflexion possède la courbe représentative de $f$ sur $\\mathbb{R}$ ?",
    options: ["$0$", "$1$", "$2$", "$4$"],
    correctAnswer: 2,
  ...
  },
  {
    id: 24,
    category: "fonctions",
    title: "Croissance comparée en l'infini",
    difficulty: "facile",
    type: "qcm",
    source: "Bac Polynésie • Juin 2022 • Sujet 1 – Ex. 1",
    question: "<b>Bac Polynésie – Juin 2022 – Sujet 1</b><br>Quelle est la limite en $+\\infty$ de la fonction $f(x) = \\frac{e^x}{x^2}$ ?",
  ...
  },
  {
    id: 25,
    category: "fonctions",
    title: "Limite de fonction avec logarithme",
    difficulty: "moyen",
    type: "qcm",
    source: "Bac Métropole • Juin 2022 • Sujet 1 – Ex. 2",
    question: "<b>Bac Métropole – Juin 2022 – Sujet 1</b><br>Déterminer la limite en $0^+$ de la fonction $f(x) = x \\ln(x)$.",
  ...
  },
  {
    id: 26,
    category: "fonctions",
    title: "Nombre de solutions par le TVI",
    difficulty: "moyen",
    type: "qcm",
    source: "Bac Nouvelle-Calédonie • Juin 2021 • Sujet 1 – Ex. 2",
    question: "<b>Bac Nouvelle-Calédonie – Juin 2021 – Sujet 1</b><br>Soit $f$ continue et strictement croissante sur $[1; 5]$ telle que $f(1) = -3$ et $f(5) = 4$. Combien de solutions admet l'équation $f(x) = 0$ sur $[1; 5]$ ?",
  ...
  },
  {
    ...
    difficulty: "facile",
    type: "ouvert",
    source: "Bac Centres Étrangers • Juin 2022 • Sujet 1 – Ex. 1",
    question: "<b>Bac Centres Étrangers – Juin 2022 – Sujet 1</b><br>Soit la fonction $f(x) = \\ln(x^2 + 3)$. <br> Déterminer la valeur exacte de la dérivée $f'(1)$.",
    correctAnswer: "0.5",
  ...
  },
  {
    id: 28,
    category: "fonctions",
    title: "Coût marginal et convexité",
    difficulty: "facile",
    type: "qcm",
    source: "Bac Antilles-Guyane • Juin 2022 • Sujet 2 – Ex. 1",
    question: "<b>Bac Antilles-Guyane – Juin 2022 – Sujet 2</b><br>Si la courbe du coût de production d'une entreprise est convexe sur un intervalle, que peut-on dire de sa dérivée seconde ?",
    options: [
  ...
  },
  {
    ...
    difficulty: "moyen",
    type: "ouvert",
    source: "Bac Asie • Juin 2021 • Sujet 1 – Ex. 1",
    question: "<b>Bac Asie – Juin 2021 – Sujet 1</b><br>Soit $f(x) = e^x$. Déterminer le coefficient directeur de la tangente à la courbe de $f$ au point d'abscisse $x=0$.",
    correctAnswer: "1",
  ...
  },
  {
    id: 30,
    category: "fonctions",
    title: "Limite avec indétermination de l'exponentielle",
    difficulty: "difficile",
    type: "qcm",
    source: "Bac La Réunion • Juin 2021 • Sujet 1 – Ex. 3",
    question: "<b>Bac La Réunion – Juin 2021 – Sujet 1</b><br>Déterminer la limite en $+\\infty$ de la fonction $f(x) = e^x - x$.",
  ...
  },
  {
    id: 31,
    category: "fonctions",
    title: "Étude du logarithme népérien",
    difficulty: "facile",
    type: "qcm",
    source: "Bac Polynésie • Juin 2021 • Sujet 1 – Ex. 1",
    question: "<b>Bac Polynésie – Juin 2021 – Sujet 1</b><br>Sur quel intervalle la fonction $f(x) = \\ln(x)$ est-elle définie ?",
  ...
  },
  {
    ...
    difficulty: "facile",
    type: "ouvert",
    source: "Bac Métropole • Juin 2023 • Sujet 2 – Ex. 1",
    question: "<b>Bac Métropole – Juin 2023 – Sujet 2</b><br>Soit la fonction $f(x) = 3x^2 - 5x + 2$. <br> Calculer la valeur exacte de la dérivée $f'(2)$.",
    correctAnswer: "7",
  ...
  },
  {
    id: 33,
    category: "fonctions",
    title: "Convexité d'une fonction rationnelle",
    difficulty: "difficile",
    type: "qcm",
    source: "Bac Amérique du Nord • Juin 2022 • Sujet 1 – Ex. 2",
    question: "<b>Bac Amérique du Nord – Juin 2022 – Sujet 1</b><br>Soit la fonction $f(x) = \\frac{1}{x}$ définie sur $]0; +\\infty[$. Quel est l'état de convexité de $f$ ?",
    options: [
      "Elle est concave",
      "Elle est convexe",
  ...
  },
  {
    ...
    difficulty: "moyen",
    type: "ouvert",
    source: "Bac Métropole • Septembre 2022 • Sujet 1 – Ex. 2",
    question: "<b>Bac Métropole – Septembre 2022 – Sujet 1</b><br>Soit la fonction $f(x) = -x^2 e^x$ définie sur $\\mathbb{R}$. A quelle abscisse $x$ la fonction atteint-elle son maximum local (sur $]-2; 2[$) ?",
    correctAnswer: "0",
  ...
  },
  {
    id: 35,
    category: "fonctions",
    title: "Théorème de continuité",
    difficulty: "facile",
    type: "qcm",
    source: "Bac Asie • Juin 2023 • Sujet 1 – Ex. 1",
    question: "<b>Bac Asie – Juin 2023 – Sujet 1</b><br>Si une fonction $f$ est dérivable sur un intervalle $I$, alors :",
    options: [
  ...
  },
  {
    ...
    difficulty: "facile",
    type: "ouvert",
    source: "Bac Polynésie • Juin 2023 • Sujet 2 – Ex. 1",
    question: "<b>Bac Polynésie – Juin 2023 – Sujet 2</b><br>A quelle abscisse $x$ la courbe de la fonction $f(x) = x^2 - 6x + 9$ admet-elle une tangente horizontale ?",
    correctAnswer: "3",
  ...
  },
  {
    ...
    difficulty: "facile",
    type: "qcm",
    source: "Bac Antilles-Guyane • Juin 2023 • Sujet 1 – Ex. 1",
    question: "<b>Bac Antilles-Guyane – Juin 2023 – Sujet 1</b><br>Soit $f$ telle que $\\lim_{x \\to +\\infty} f(x) = 3$. La droite d'équation :",
    options: [
  ...
  },
  {
    ...
    difficulty: "moyen",
    type: "ouvert",
    source: "Bac Métropole • Juin 2021 • Sujet 2 – Ex. 2",
    question: "<b>Bac Métropole – Juin 2021 – Sujet 2</b><br>Soit la fonction $f(x) = \\ln(x - 2)$. <br> Pour quelle valeur de $x$ la courbe représentative de $f$ coupe-t-elle l'axe des abscisses ?",
    correctAnswer: "3",
  ...
  },
  {
    id: 39,
    category: "fonctions",
    title: "Limite de quotient indéterminé",
    difficulty: "difficile",
    type: "qcm",
    source: "Bac La Réunion • Juin 2022 • Sujet 1 – Ex. 2",
    question: "<b>Bac La Réunion – Juin 2022 – Sujet 1</b><br>Déterminer la limite en $0$ de la fonction $f(x) = \\frac{e^x - 1}{x}$.",
  ...
  },
  {
    ...
    question: "<b>Bac Métropole – Septembre 2022 – Sujet 2</b><br>La dérivée de la fonction $f(x) = \\ln(x)$ sur $]0; +\\infty[$ est :",
    options: [
      "Toujours négative",
      "Toujours positive",
      "S'annule en $x=1$",
